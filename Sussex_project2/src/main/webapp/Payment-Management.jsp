...
<link rel="stylesheet" href="Payment-Management.css" media="screen">
    ...
    <meta property="og:title" content="Payment Management">
    <meta property="og:type" content="website">
  </head>
  <body class="u-body">
    <header class="u-align-center u-clearfix u-custom-color-1 u-header u-header" id="sec-6dad"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-grey-10 u-section-1" id="sec-c617">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          ...
          <form method="POST" action="SearchPayment" class="horzontalform" name="form" style="padding: 10px;">
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-align-center u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">Full name</th>
                <th class="u-border-1 u-border-black u-table-cell">Bank Reference</th>
                <th class="u-border-1 u-border-black u-table-cell">Payment for</th>
                <th class="u-border-1 u-border-black u-table-cell">Additional Note</th>
              ...
              <c:forEach var="payment" items="${paymentList}">
              	...
              	<tr style="height: 30px;">
	                <td class="u-border-1 u-border-grey-30 u-table-cell">${payment.prg}</td>
	                <td class="u-border-1 u-border-grey-30 u-table-cell">${payment.fullName}</td>
	                <td class="u-border-1 u-border-grey-30 u-table-cell">${payment.bankReference}</td>
	                <td class="u-border-1 u-border-grey-30 u-table-cell">${payment.paymentFor}</td>
	                <td class="u-border-1 u-border-grey-30 u-table-cell">${payment.addtionalNote}</td>
	                
	                <c:url value="ViewImage" var="url">
					  <c:param name="filepath" value="${payment.image}" />
					</c:url>
	                
	                <td class="u-border-1 u-border-grey-30 u-table-cell">
	                 <a href ="${url}" class="button2">Image</a>
	                 <a href ="DeletePayment?bankReference=${payment.bankReference}" class="button3">Delete</a>
	                </td>
              	</tr>
