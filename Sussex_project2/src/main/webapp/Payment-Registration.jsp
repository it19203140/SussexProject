...
<link rel="stylesheet" href="Payment-Registration.css" media="screen">
            ...
            <div class="u-expanded-width u-form u-form-1">
              ...
              <form action="RegisterPayment" method="POST" onsubmit="return confirm('Are you sure you have entered valid details ?')" class="" style="padding: 10px" source="custom" name="form" enctype="multipart/form-data">
                ...
                <div class="u-form-group">
                  ...
                  <input type="text" placeholder="Enter student PRG" id="name-3b9a" name="prg" class="u-border-1 u-border-black u-input u-input-rectangle u-input-1" required="required" value="${payment.prg}">
                  <br>
                </div>
                <div class="u-form-group">
                ...
                <div class="u-form-group u-form-textarea u-form-group-7">
                  ...
                  <textarea rows="4" cols="50" id="textarea-c565" name="note" class="u-border-1 u-border-black u-input u-input-rectangle u-input-7" placeholder="Enter additional details such as amount, payment date..."></textarea>
                  <br>
                </div>
