...
<link rel="stylesheet" href="Update-User.css" media="screen">
    ...
    <meta property="og:title" content="Update User">
  ...
  <body class="u-body"><header class="u-align-center u-clearfix u-custom-color-1 u-header u-header" id="sec-6dad"><div class="u-clearfix u-sheet u-sheet-1">
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="ListUser" style="padding: 10px 20px;">User Management</a>
    ...
    <section class="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-custom-color-2 u-section-1" id="sec-014f">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-container-style u-group u-image u-image-1" data-image-width="1280" data-image-height="720">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h3 class="u-text u-text-1">Update User</h3>
            <div class="u-align-center u-form u-form-1">

              <form action="UpdateUser" method="POST" source="custom" name="form" style="padding: 10px;">
                <div class="u-form-group u-form-name">
                  <label for="name-2a5d" class="u-label u-label-1">PRG : </label>
                  <input type="text" placeholder="Enter  PRG" id="name-2a5d" name="username" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" value="${user.prg}">
                </div>
                <div class="u-form-email u-form-group">
                  <label for="email-2a5d" class="u-label u-label-2">Password</label>
                  <input type="text" placeholder="Enter Password" id="email-2a5d" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""value="${user.password}" >
                </div>
                <div class="u-align-center u-form-group u-form-submit">
                  <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-btn-1">Submit</a>
